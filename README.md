...
Details about implementing the entry point in an Automation script are available [in this how-to](https://docs.dataminer.services/develop/devguide/Automation/Howto/Implementing_OnRequestScriptInfo_Entry_Point.html).
